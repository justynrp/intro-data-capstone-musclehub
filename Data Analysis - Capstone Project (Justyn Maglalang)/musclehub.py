...
purchase_count=df.groupby(['is_member','ab_test_group']).first_name.count().reset_index()
final_member_pivot=purchase_count.pivot(columns='is_member', index='ab_test_group', values='first_name').reset_index()
...
# Plot 2 -- Percent of applicants who purchase a membership
...
plt.savefig('percent_apps_membership.png')
plt.show()
...
# Plot 3 -- Percent of visitors who purchase a membership
